...
const routes = [
  ...
  { path: '/foods', name: 'foods', component: () => import('./modules/food/views/FoodsView.vue'), meta: { auth: true } },
  { path: '/foods/new', name: 'food-new', component: () => import('./modules/food/views/FoodEdit.vue'), meta: { auth: true } },
  { path: '/foods/:id/edit', name: 'food-edit', component: () => import('./modules/food/views/FoodEdit.vue'), meta: { auth: true } },
  { path: '/foods/:id', name: 'food-detail', component: () => import('./modules/food/views/FoodDetail.vue'), meta: { auth: true } },
  ...
  { path: '/notebook', name: 'notebook', component: () => import('./modules/care/views/Notebook.vue'), meta: { auth: true } },
  { path: '/notebook/care/new', name: 'care-new', component: () => import('./modules/care/views/CareEdit.vue'), meta: { auth: true } },
  { path: '/notebook/care/:id/edit', name: 'care-edit', component: () => import('./modules/care/views/CareEdit.vue'), meta: { auth: true } },
  { path: '/notebook/rule/new', name: 'rule-new', component: () => import('./modules/rule/views/RuleEdit.vue'), meta: { auth: true } },
  { path: '/notebook/rule/:id/edit', name: 'rule-edit', component: () => import('./modules/rule/views/RuleEdit.vue'), meta: { auth: true } },
  { path: '/notebook/rule/:id/agree', name: 'rule-agree', component: () => import('./modules/rule/views/RuleAgree.vue'), meta: { auth: true } },
  { path: '/notebook/rule/:id', name: 'rule-detail', component: () => import('./modules/rule/views/RuleDetail.vue'), meta: { auth: true } },
  ...
  { path: '/observatory', name: 'observatory', component: () => import('./modules/observatory/views/Observatory.vue'), meta: { auth: true } },
