...
router.get('/memories', requireAuth, companionController.listMemories)
router.post('/memories', requireAuth, idempotency, companionController.createMemory)
router.put('/memories/:id', requireAuth, companionController.updateMemory)
router.delete('/memories/:id', requireAuth, companionController.removeMemory)
