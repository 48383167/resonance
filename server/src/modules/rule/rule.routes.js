...
router.put('/:id/items/:itemId/agree', requireAuth, ruleController.toggleItemAgree)
router.post('/:id/items', requireAuth, ruleController.appendItem)
router.patch('/:id/items/:itemId', requireAuth, ruleController.patchItem)
router.delete('/:id/items/:itemId', requireAuth, ruleController.removeItem)
